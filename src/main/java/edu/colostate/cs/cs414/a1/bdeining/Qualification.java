...
public class Qualification {
  ...
  /**
   * Creates a new instance of qualification and sets its description, if the description is valid.
   * A valid description is a non-empty string that consists of at least one non-blank character.
   *
   * @param d – the description of the qualification.
   * @throws InvalidDescription - if description is not a non-empty string that consists of at least
   ...
   * i.e., not equals(c : Qualification), etc. Two Qualification instances are equal iff their
   * descriptions match. Note that it is good practice to override the hashCode method when equals
   * is overridden.
   *
