...
public class Project {
  ...
  /**
   * Creates an instance of a project given a valid name, size, status, and qualifications. A name
   * is valid if it is a non-empty string that consists of at least one non-blank character.
   *
   ...
   */
  public Project(String name, ProjectSize size, ProjectStatus status, Set<Qualification> qs)
  ...
  /**
   * Returns the qualifications that are not met by comparing the qualifications required by the
   * project and those that are met by the workers who are assigned to the project. An empty set
   * (not a null set) is returned when all the qualification requirements are met.
   *
  ...
  public Set<Qualification> missingQualifications() {
    ...
    Set<Qualification> workerQualifications =
        workers
            .stream()
            .flatMap(worker -> worker.getQualification().stream())
  ...
  /**
   * Verifies that at least one of the missing qualification requirements of a project is satisfied
   * by the worker w.
   *
   * @param w - the worker to be analyzed.
   * @return true if at least one of the missing qualification requirements of a project is
   *     satisfied by the worker, false otherwise.
